...
describe UsersController do
  describe "route generation" do
    it "should route {:controller => 'users', :action => 'index'} to /users" do
      route_for(:controller => 'users', :action => 'index').should == "/users"
    end
    
    it "should route {:controller => 'users', :action => 'new'} to /users/new" do
      route_for(:controller => 'users', :action => 'new').should == "/users/new"
    end
    
    it "should route {:controller => 'users', :action => 'create'} to /users" do
      route_for(:controller => 'users', :action => 'create').should == "/users"
    end
    
    it "should route {:controller => 'users', :action => 'show', :id => '1'} to /users/1" do
      route_for(:controller => 'users', :action => 'show', :id => '1').should == "/users/1"
    end
    
    it "should route {:controller => 'users', :action => 'edit', :id => '1'} to /users/1/edit" do
      route_for(:controller => 'users', :action => 'edit', :id => '1').should == "/users/1/edit"
    end
    
    it "should route {:controller => 'users', :action => 'update', :id => '1'} to /users/1" do
      route_for(:controller => 'users', :action => 'update', :id => '1').should == "/users/1"
    end
    
    it "should route {:controller => 'users', :action => 'destroy', :id => '1'} to /users/1" do
  ...
  describe "route recognition" do
    ...
    it "should generate params {:controller => 'users', :action => 'new'} from GET /users" do
